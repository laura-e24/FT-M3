...
//   });
  ...
  // AsyncAwait version
   ...
   console.log('-- An. async/await version --');
   blue(stanza)
}
...
//   });
  ...
  // AsyncAwait version
   try {
      ...
      console.log('-- An. async/await version --');
      blue(stanzaThree)
      const stanzaFour = await promisifiedReadFile('poem-one/stanza-04.txt')
      blue(stanzaFour)
   } catch (error) {
      magenta(error)
   }
...
//   });
  ...
  // AsyncAwait version
   try {
      const stanzaThree = await promisifiedReadFile('poem-one/stanza-03.txt')
      const stanzaFour = await promisifiedReadFile('poem-one/wrong-file-name.txt.txt')
      console.log('-- An. async/await version --');
      blue(stanzaThree)
      blue(stanzaFour)
   } catch (error) {
